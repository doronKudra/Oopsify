		...
		<header className="app-header">
			...
			<section className='search-container'>
				...
				<div className='search-bar'>
					<svg data-encore-id="icon" role="img" aria-hidden="true" className="magnifying-glass" data-testid="search-icon" viewBox="0 0 24 24" >
					...
					{filterBy.txt && <div onClick={onClearTxt} className="xmark">
