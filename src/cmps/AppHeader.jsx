...
export function AppHeader() {
    ...
    const userInitial = loggedInUser ? getInitial(loggedInUser.fullName) : '#'
    ...
    return (
        <header className="app-header">
            <svg
                ...
                role="img"
                viewBox="0 0 24 24"
                className="spotify-logo e-91000-logo e-91000-baseline"
                aria-label="Spotify"
                aria-hidden="false"
                height="32"
                    ...
                    {location.pathname === '/genres' ? (
                        <div className="search-genre-btn">
                            <svg
                                ...
                                role="img"
                                aria-hidden="true"
                                className="search-genre-svg active"
                                viewBox="0 0 24 24"
                            >
            ...
            {loggedInUser ? (
                <button className="loggedInUser-btn" onClick={onLogout}>
                    {userInitial}
                </button>
            ) : (
